    ...
    <aside class="top-0 sticky flex flex-col h-screen sidebar">
        ...
        <nav class="flex-grow mt-4">
            <ul>
                ...
                <li>
                    <a href="/admin/shrimp-menu" class="active">
        ...
        <div class="p-6 border-gray-200 border-t">
            <!-- LOGOUT BUTTON -->
            <a href="/logout" class="flex justify-center items-center bg-[var(--color-button)] hover:bg-[var(--color-button-dark)] shadow-md px-4 py-2 rounded-lg font-semibold text-white transition-colors">
